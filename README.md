...
- AI & Machine Learning based applications  
- Voice-enabled systems and chatbots  
- Computer Vision & OCR projects  
- Full-stack and API-driven platforms  
...
### 🤖 **Bobby AI – Voice Activated Chatbot**
A smart voice-based assistant capable of answering questions, fetching weather & news, and handling conversational tasks using AI and APIs.
...
### 🧠 **FacialRec – Face Detection & Recognition**
A computer vision project built using OpenCV to detect and recognize faces in real time.
...
An AI-powered system that analyzes handwritten and digital medical prescriptions to extract and interpret medicine names accurately.
...
## ⚡ Fun Facts
- I love building **AI projects that solve real problems**  
